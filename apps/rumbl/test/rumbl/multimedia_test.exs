defmodule Rumbl.MultimediaTest do
  ...
  describe "videos" do
    ...
    test "list_videos/0 returns all videos" do
      ...
      %Video{id: id1, title: title1} = video_fixture(owner, %{title: "My Title"})
      assert [%Video{id: ^id1, title: ^title1}] = Multimedia.list_videos()
  ...
  test "change_video/1 returnns a video changeset" do
    owner = user_fixture()
    video = video_fixture(owner)
